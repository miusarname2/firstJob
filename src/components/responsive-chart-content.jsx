...
export function ResponsiveChartContent() {
  return (
    <div className=" sm:px-4 lg:px-6 sm:py-6 lg:py-8 max-w-7xl ">
      <div className="flex flex-col sm:flex-row justify-between items-center">
        <div className="flex items-center">
          <CalendarDaysIcon className="h-6 w-6 text-gray-500" />
          <span className="ml-2 text-sm font-medium text-gray-700">Jan 20, 2023 - Feb 09, 2023</span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
        ...
        <Card className="col-span-1">
          ...
          <CardContent>
            <p className="text-xl font-semibold">+2350</p>
